...
The following milestones will guide the implementation process to achieve theoutlined objectives. The Bachelor’s thesis starts on _TODO_ and will becompleted on _TODO_. To ensure a structured and timely completion of theproject, the following schedule is planned:
