...
#figure(
  image("/figures/activity_mcp.drawio.svg", height: 60%),
  caption: [Activity Diagram of basic MCP Client workflow],
)
...
#figure(
  image("/figures/activity_basic_workflow.drawio.svg", height: 70%),
...
= Workflow of Artemis Integration Test
#figure(
