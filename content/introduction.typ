...
From an operational perspective, universities must serve large cohorts of students simultaneously, often under strict time constraints. Without systematic scalability testing, institutions risk performance bottlenecks and failures that can jeopardize entire examinations. This makes automated verification and realistic load simulations an essential component of quality assurance in digital learning environments. 

=== Scientific Perspective
From a scientific standpoint, testing interactive web applications such as cloud-based IDEs remains a challenging and underexplored problem. End-to-end testing approaches must account for asynchronous user interactions, real-time feedback, and integration with external services. Furthermore, scalability testing in the context of cloud-native education infrastructure introduces unique challenges: hundreds of parallel user sessions, varying network conditions, and the need to reproduce realistic student workflows. Existing research on SaaS testing and performance engineering @tsai:2011:TestingScalabilitySaaS provides valuable foundations, but the educational use case introduces distinct requirements regarding fairness, reliability, and usability.

By addressing both functional correctness and load behavior in a unified framework, this thesis contributes to ongoing research in end-to-end testing, performance engineering, and educational technology. The results not only enhance the reliability of Theia Cloud within Artemis but also provide transferable insights for the design and testing of other cloud-based educational systems. 
