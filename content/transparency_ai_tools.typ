...
In preparing this thesis, I utilized Grammarly #footnote("https://app.grammarly.com") for grammar and style correction across the Abstract, Introduction, and Conclusion sections, ensuring clarity and coherence in my writing. I used DeepL #footnote("https://deepl.com") to enhance language quality and translate parts of the Literature Review. I used ChatGPT #footnote("https://chatgpt.com") to generate initial drafts and expand on ideas in the Introduction and Discussion sections, providing valuable suggestions and examples. Additionally, I used Claude Sonnet #footnote("https://anthropic.com/") to generate code snippets for the developed functionality and code snippets in the Methodology section. I have carefully checked all texts created with these tools to ensure that they are correct and make sense.